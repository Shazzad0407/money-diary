...
public class AddedCost extends AbstractClass implements ActionListener,MouseListener {
    Object[] row = new Object[5];
    String filePath,brString,uName;

    public AddedCost(String uName){
        ...
        if(e.getSource()==addBt)
        {
            ...
            if(!(amountTf.getText().isEmpty()))
            {
                ...
                try{
                    ...
                    FileWriter fw = new FileWriter(filePath+"/cost.txt", true);
